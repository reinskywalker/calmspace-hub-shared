                    ...
                    <div class="container px-5 py-10 mx-auto">
                        ...
                        <form method="POST" action="{{ route('mood.track') }}">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                                ...
                                <button type="submit" name="mood_code" value="{{ $mood->code }}" class="p-4 flex flex-col items-center justify-center border-2 border-gray-200 rounded-lg bg-white hover:bg-indigo-100 focus:outline-none">
